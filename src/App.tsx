        ...
        <section className="hero">
          <div className="wrap herohead">
            <div className="herocol">
              ...
              <p className="sub rv">
                I write software for a living and run <b>BashBop</b>, an events company, on the
                side. Most of my open-source work started because I hit the same problem twice in
                my own repos and got tired of guessing.
              </p>
            </div>
            <figure className="heroportrait rv">
              <img src={`${import.meta.env.BASE_URL}me.jpg`} alt="Oluwasegun Olumbe" width={825} height={1100} />
            </figure>
          </div>
        </section>
